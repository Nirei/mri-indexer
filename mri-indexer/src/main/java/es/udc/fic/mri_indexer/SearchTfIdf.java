...
public class SearchTfIdf {
	...
	public void searching() {
		try {
			...
			N = reader.numDocs();
			List<String> topDocs = calcTopTerms(reader);
	...
	private List<String> calcTopTerms(IndexReader reader) throws IOException {
		...
		while (termsEnum.next() != null) {
			...
			if (lista != null) {
				...
				while ((docx = lista.nextDoc()) != DocIdSetIterator.NO_MORE_DOCS) {
					...
					termino = "TF*IDF: " + tfidf + " ( docid: " + docx + ", termino: " + nombrestring + " )" + " tf: "
